// -*- C++ -*-
// $Id: readwrite.h, v1.0 2020-10-8 Kyon$
// $Id: readwrite.h, v1.1 2021-01-13 Kyon$
/*! \file
 * \brief read of existed kyu propagator.
 */
...
struct io_vec
{
	...
	io_vec(bool _single, size_t io_num, bool _endian);
	...
	void writeR(FILE* filehand);
	
	void readRD(FILE* filehand);

	void readRF(FILE* filehand);

	void writeRD(FILE* filehand);

	void writeRF(FILE* filehand);
};
